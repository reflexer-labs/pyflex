...
print(f"redemption price                   {float(str(geb.oracle_relayer.redemption_price())):.8f}")
print(f"redemption rate                    {float(str(geb.oracle_relayer.redemption_rate())):.16f}")
print(f"collateral_type                    {str(geb.oracle_relayer.collateral_type('ETH-A'))}")
print("")
print("Collateral")
print("-------------------------------")
