...
from pyflex import Address, eth_transfer, get_pending_transactions, RecoveredTransact, TransactStatus, Calldata, Receipt
...
class TestTransactReplace:
    ...
    async def test_transaction_replace(self):
        ...
        future_receipt_2 = asyncio.ensure_future(transact_2.transact_async(replace=transact_1, gas_price=FixedGasPrice(150000)))
        # and
