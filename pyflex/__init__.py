...
def _get_nonce_calc(web3: Web3) -> NonceCalculation:
    ...
    if web3 not in nonce_calc:
        ...
        #elif is_parity and requires_serial_nonce:
                    ...
                    for tx_hash in self.tx_hashes:
                        ...
                        if receipt:
                            if receipt.successful:
                                ...
                                self.logger.warning(f"Transaction {self.name()} status is '0x0'."
                                                    f" Assuming it has failed (tx_hash={bytes_to_hexstring(tx_hash)})")
                                return None
